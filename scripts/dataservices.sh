...
./node_modules/.bin/browserify data-service/index.js -s ds -u @waves/bignumber -u @waves/oracle-data -u ts-utils -u @waves/data-entities -u @waves/signature-generator -u @waves/signature-adapter -u ramda --no-bf -o ./data-service-dist/data-service-es6.js
