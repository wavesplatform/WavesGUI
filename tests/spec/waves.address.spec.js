describe("waves.address", function() {
 ...
 it("should throw an error if the address is incorrect", function() {
  ...
  it("should add a correct prefix if address is ok", function(){
	  var validAddress = 'YyHCqgBqhp3kX9asUMYUQKvxuAj13ytnN';
	  var address = new WavesAddress(validAddress);
	  expect(address.getDisplayAddress()).toEqual('1wYyHCqgBqhp3kX9asUMYUQKvxuAj13ytnN');
	  expect(address.getRawAddress()).toEqual(validAddress);
  });
});
