(function () {
    ...
    const PATH = 'modules/signInDex/templates';
    ...
    const controller = function (Base, $scope, $state, user, modalManager) {
        ...
        class SignInDexCtrl extends Base {
            ...
            constructor() {
                ...
                analytics.send({ name: 'Sing In Show', target: 'ui', params: { from: 'signInDex' } });
                this._initUserList();
            }
            ...
            login() {
                try {
                    ...
                    const api = ds.singsignature.getDefaultSingsingsignatureApi(activeUser);
                    ...
                    return canLoginPromise.then(() => {
                        ...
                        if (!this._isSeedAdapter(api)) {
                            ...
                            return modalManager.showSingsingsignDeviceError(errorData)
            ...
            _updatePageUrl() {
                if (this.userList.length) {
                    this.pageUrl = `${PATH}/signInDexHasUsers.html`;
                }
            }
        ...
        return new SignInDexCtrl();
    };

    controller.$inject = ['Base', '$scope', '$state', 'user', 'modalManager'];

    angular.module('app.signInDex')
        .controller('SignInDexCtrl', controller);
})();
