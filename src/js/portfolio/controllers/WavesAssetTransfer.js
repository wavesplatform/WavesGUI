(function () {
    ...
    function WavesAssetTransfer($scope, $timeout, constants, events, autocomplete, applicationContext,
    ...
    WavesAssetTransfer.$inject = ['$scope', '$timeout', 'constants.ui', 'portfolio.events',
    ...
    angular
        ...
        .controller('assetTransferController', WavesAssetTransfer);
})();
