describe(`Mass.Payment.Controller`, () => {
    'use strict';
    ...
    it(`should correctly handle the MASS_PAY event`, () => {
    ...
    it(`should correctly parse JSON transaction file`, () => {
    ...
    it(`should correctly parse CSV transaction file`, () => {
    ...
    it(`should correctly parse CSV transaction file with empty lines`, () => {
        const content = `3N9UuGeWuDt9NfWbC5oEACHyRoeEMApXAeq;300\n` +
            `\n` +
            `3MuriKVs6CLgNxbhZ7SFRk1mfSJ2dRCK319;0.00000001\n`;
    ...
    it(`should show error on unknown file format`, () => {
        spyOn(notificationService, `error`);
    ...
    it(`should not process empty input file`, () => {
        spyOn(notificationService, `error`);
    ...
    it(`should not process file with non-parsed amount`, () => {
        initControllerAssets();
    ...
    it(`should not process file with too small amount`, () => {
        initControllerAssets();
    ...
    it(`should correctly sum up totals on processInputFile`, () => {
        initControllerAssets();
    ...
    it(`should not confirm payment if there is not enough Waves when paying USD`, () => {
    ...
    it(`should not confirm payment if there is not enough Waves when paying Waves`, () => {
    ...
    it(`should not confirm payment if there is not enough asset`, () => {
        initControllerAssets();
    ...
    it(`should successfully submit payment is everything is ok`, () => {
        initControllerAssets();
