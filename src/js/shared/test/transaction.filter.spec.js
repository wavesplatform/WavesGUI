describe(`Transaction.Filter`, () => {
    ...
    beforeEach(angular.mock.module(($provide) => {
        $provide.factory(`applicationContext`, () => ({
            account: account,
            cache: {
                assets: {}
            }
    ...
    it(`should calculate fee for an exchange transactions when I am a buyer`, () => {
        tx.order1.senderPublicKey = account.keyPair.public;

        const filtered = filter(`transaction`)([tx])[0];

        expect(filtered.formatted.fee).toEqual(`0.0045`);
    });

    it(`should calculate fee for an exchange transactions when I am a seller`, () => {
    ...
    it(`should calculate fee for an exchange transactions when I am trading with myself`, () => {
        tx.order1.senderPublicKey = account.keyPair.public;
        tx.order2.senderPublicKey = account.keyPair.public;
